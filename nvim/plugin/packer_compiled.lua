...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/home/vincent/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["symbols-outline.nvim"] = {
    loaded = true,
    path = "/home/vincent/.local/share/nvim/site/pack/packer/start/symbols-outline.nvim",
  ...
  ["vim-startuptime"] = {
    loaded = true,
    path = "/home/vincent/.local/share/nvim/site/pack/packer/start/vim-startuptime",
